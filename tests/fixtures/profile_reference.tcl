...
original_profile_title {D-Flow / default}
preinfusion_flow_rate 4
preinfusion_guarantee 0
preinfusion_stop_pressure 4.0
preinfusion_time 20
pressure_end 4.0
profile_filename D-Flow____default
profile_language en
profile_notes {A simple to use profiling system By Damian Brakel D-Flow's Default profile is provided as an example profile for you to get started in creating your own

Downloaded from Visualizer}
profile_title {D-Flow / default}
profile_to_save {D-Flow / default}
